"""v6hit_extreme モデル学習スクリプト（LambdaRank・1着のみ評価）

v4 の CSV（67列）を使い、label_gain=[0,0,0,0,100] で
1着以外のゲインを0にすることで「1着を当てること」だけを最適化する。
...
モデルは "_v6hit_extreme" サフィックスで保存。

実行:
    python scripts/train_v6hit_extreme_models.py
"""
...
if __name__ == "__main__":
    print("=" * 55)
    print("v6hit_extreme モデル学習（LambdaRank・1着のみ評価）")
